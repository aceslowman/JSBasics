...
function timesTen(arr){
  var newArr = arr.map(function(x) { return x * 10; });
  return newArr;
}
...
function speechMaker(obj){ return obj.speech(); }
...
var cars = [new Car(),new Car(),new Car()];
